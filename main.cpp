...
int main() {
    ...
    radix_tree.find("aha");
    radix_tree.insert(std::make_pair<std::string, int>("ahi", 1));
    radix_tree.insert(std::make_pair<std::string, int>("xyz", 1));
    radix_tree.insert(std::make_pair<std::string, int>("ahihi", 1));
    //radix_tree.insert(std::make_pair<std::string, int>("a", 1));
    return 0;
}
